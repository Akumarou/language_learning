...
public class InstructorQuestionController {
     ...
     */
    @GetMapping("instructor/changeQuestion")
    public String getAllQuestions(
        ...
        switch (givenAction) {
            case "add":
                ...
                return "/instructor/changeQuestion";
            case "update":
            ...
            case "delete":
                ...
                theCourseService.deleteQuestionById(id, qType);
     ...
     */
    @PostMapping("/instructor/inputQuestion")
    ...
    @PostMapping("/instructor/singleQuestion")
    ...
    @PostMapping("/instructor/multiQuestion")
